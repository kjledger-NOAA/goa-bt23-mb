---
title: "Decontamination of BT 2023 MiFish Amplicons"
author: "Kimberly Ledger"
output: html_document
date: "2025-03-11"
---

** this just a prelim look.. for now working with the TAXA decontamination code ***
...
there are quite a few ASVs associated with field blanks - at least far more than i am used to having in a dataset. only two of these asvs also show up in field samples (ASV_017 - Oncorhynchus tshawytscha and ASV_077 - Sebastes entomelas)

for now, during data exploration, i'm going to keep all of these asvs and reads 
